...
def Options():
    Type(Fore.LIGHTCYAN_EX + "[ " + blue + "1" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option  " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Pep  GPT")
    Type(Fore.LIGHTCYAN_EX + "[ " + blue + "2" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Use api_key")
    Type(Fore.LIGHTCYAN_EX + "[ " + blue + "3" + Fore.LIGHTCYAN_EX + " ]" + w +  "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Update")
    Type(Fore.LIGHTCYAN_EX + "[ " + blue + "5" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Exit")
    backslash()
...
class Main(_sethMacfl_Functions):
    ...
    def FuncRule(self):
        if self.ask == 1:
            ...
            # Remover a reinicialização desnecessária aqui
            sys.exit()
...
# Remove a reinicialização
if sethMacfl.ask == 1:
    while True:
        Pep()
        sethMacfl.questions = Question2("Type a message: ")
        sethMacfl.FuncRule()  # Gera a resposta da IA aqui
        Pep()
