...
def Options():
    Type(Fore.LIGHTCYAN_EX + "[ " + Purple + "1" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option  " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Pep  GPT")
    Type(Fore.LIGHTCYAN_EX + "[ " + Purple + "2" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Key Configure")
    Type(Fore.LIGHTCYAN_EX + "[ " + Purple + "3" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Join Channel ")
    Type(Fore.LIGHTCYAN_EX + "[ " + Purple + "4" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Update")
