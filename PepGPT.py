...
def Options():
    Type(Fore.LIGHTCYAN_EX + "[ " + u_purple + "1" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option  " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Pep  GPT")
    Type(Fore.LIGHTCYAN_EX + "[ " + u_purple + "2" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Key Configure")
    Type(Fore.LIGHTCYAN_EX + "[ " + u_purple + "3" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Join Channel ")
    Type(Fore.LIGHTCYAN_EX + "[ " + u_purple + "4" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Update")
    Type(Fore.LIGHTCYAN_EX + "[ " + Purple + "5" + Fore.LIGHTCYAN_EX + " ]" + w + "\033[1;37m Option " + Fore.LIGHTCYAN_EX + "||" + Fore.WHITE + " Exit")
    backslash()
